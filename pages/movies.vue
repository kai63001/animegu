<template>
  <div id="app">
    ...
    <h1 class="color-dark text-center">
      THE MOVIES ANIME GU <span v-if="page != 1">PAGE : {{ page }}</span>
    </h1>
    <br>
    <div class="container">
      <h3>Anime the Movies</h3>
      <div class="row">
...
export default {
  ...
  async asyncData ({ query, err, req }) {
    ...
    const game = await axios.get(
      'http://f21085dd.ngrok.io/api/movie?page=' + query.page
    )
  ...
  head () {
    return {
      title: 'AnimeGu - Watch The Movies Anime online free full hd download',
      meta: [
        {
          vmid: 'description',
          name: 'description',
          content: 'Watch and download the movies anime cartoon free online full hd english sub and dub eng view'
        },
        {
          property: 'og:title',
          content: 'AnimeGu - Watch movies Anime online free full hd download'
        },
        ...
        // Often the same as your meta description, but not always.
        {
          ...
          content: 'Watch and download movies anime cartoon free online full hd english sub and dub eng view'
        },
        ...
        { itemprop: 'description', content: 'Watch and download movies anime cartoon free online full hd english sub and dub eng view' },
        {
          itemprop: 'image',
          content: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400/553e9750160831.58c8ff8bc2909.png'
        }
